// countryPhoneLengths.js - Replace with your full countryPhoneLengths object

// Map of country dialing codes and their corresponding phone number lengths
const countryPhoneLengths = {
    // Include all country codes and lengths as provided
    '+1': 10, // USA, Canada
    '+20': 10, // Egypt
    '+30': 10, // Greece
    '+31': 9, // Netherlands
...
// Function to get the user's country code from the API
async function getCountryCode() {
    try {
        ...
        if (countryCode in countryPhoneLengths) {
            ...
            countryCode = '';
            countryLength = 10; // Fallback length
        }
        updatePlaceholder();
    } catch (error) {
...
// Function to update the input placeholder with the country code
...
// Function to show the "Select Your Country" input if API fails
function showSelectCountry() {
    const selectCountryInput = document.getElementById('selectCountry');
    selectCountryInput.style.display = 'block';
}
